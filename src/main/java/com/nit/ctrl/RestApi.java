...
public class RestApi {
	...
	public String welcome() {
		...
		return "<h1 style=color:red;text-align:center>Welcome to Rest Controller Application</h1>";
	}
	...
	public String wish(@PathVariable String name) {
		...
		return "<h1 style=color:green;text-align:center>Hi Mr/mrs "+name+" Welcome </h1>";
	}
